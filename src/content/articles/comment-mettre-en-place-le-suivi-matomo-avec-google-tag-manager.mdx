...
![Copier le code de suivi Matomo](/image/articles/code-suivi-matomo.png)
...
![Balise Google Tag Manager](/image/articles/tag-html-matomo.png)
...
![Balise Template Matomo Dans Google Tag Manager](/image/articles/balise-template-matomo.png)

![Configuration Matomo dans Google Tag Manager](/image/articles/configuration-balise-matomo.png)
...
![Déclencheur Google Tag Manager](/image/articles/declencheur-matomo.jpg)
...
![Prévisualisation Google Tag Manager](/image/articles/matomo-succeded.jpg)
...
![Publication de votre conteneur](/image/articles/publication-conteneur-gtm.png)
...
![Visites en temps réel sur Matomo](/image/articles/visite-en-temps-reel.png)

Attention, cette fonctionnalité n’est pas compatible si vous souhaitez [mettre en place le suivi sans consentement avec Matomo](/tout-savoir-sur-les-rapports-personnalises-matomo).
