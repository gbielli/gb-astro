...
date: "2023-03-09"
image: "/image/articles/suivi-sans-consentement-matomo.jpg"
categories: ["Matomo"]
---

import Callout from "@/components/Callout.astro";

Le temps de l'hésitation entre [Google Analytics vs Matomo](/matomo-vs-google-analytics-quelles-differences-et-comment-choisir) est bien passé, et il est temps de revenir sur le sujet. La CNIL a décidé de mettre en place un nouveau suivi de base pour les sites web, et c'est le cas de Matomo.
...
![anonymisation des données](/image/articles/anonymisation-donnee-matomo.png)
...
![Anonymiser les IP](/image/articles/anonymisation-donnee-matomo.png)
