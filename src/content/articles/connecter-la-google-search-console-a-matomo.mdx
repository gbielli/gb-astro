...
date: "2023-04-30"
image: "/image/articles/matomo-search-console.jpg"
categories: ["Matomo"]
---
...
![création d'un projet GCP](/image/articles/search-matomo/new-project-gcp-1.png)
...
![ecran de consentement oauth](/image/articles/search-matomo/ecran-consentement-2.png)

![ecran consentement externe](/image/articles/search-matomo/ecran-consent-externe-3.jpg)
...
- **Coordonnées du développeur** : votre email
  ...
  ![application google cloud platform](/image/articles/search-matomo/application-gcp-4.png)

  ![domaine autorisé google coud platform](/image/articles/search-matomo/domaine-gcp-5.png)

  ![identifiant google cloud platform](/image/articles/search-matomo/identifiants-gcp-6.png)
...
![télécharger le json](/image/articles/search-matomo/download-json-7.png)
...
![accès google](/image/articles/search-matomo/acces-google-8.png)
