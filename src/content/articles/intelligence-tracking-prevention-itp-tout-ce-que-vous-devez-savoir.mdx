...
En juin 2017, Apple annonce l'Intelligent Tracking Prevention (ITP) 1.0 à la WWDC. ITP est une solution qui utilise le machine learning et s'exécute on-device (sur l'appareil de l'utilisateur). L'objectif est simple : protéger les utilisateurs de Safari (et par extension iOS, ipadOS) du cross-site tracking en limitant la durée de vie des **cookies tiers**.
