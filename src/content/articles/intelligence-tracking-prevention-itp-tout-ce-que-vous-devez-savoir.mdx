...
En d'autres termes, tous les cookies permettant à un service tiers sur votre site d'identifier un utilisateur en déposant des cookies sont voués à disparaître après 7 jours sur Safari. Cette suppression impactera par exemple :
