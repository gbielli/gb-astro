...
Maintenant que nous avons intégré un conteneur GTM dans l'iframe, il nous faut utiliser la méthode [postMessage](https://developer.mozilla.org/fr/docs/Web/API/Window/postMessage) pour envoyer un event à ton site parent.
