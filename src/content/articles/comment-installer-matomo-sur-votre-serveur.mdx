...
![téléchargement de la dernière version de matomo](/src/assets/articles/serveur-matomo/matomo-latest-1.png)
...
![informations sur ovh](/src/assets/articles/serveur-matomo/ovh-2.png)
...
![ports mamp](/src/assets/articles/serveur-matomo/ports-3.png)
...
![configuration mamp](/src/assets/articles/serveur-matomo/mamp-4.png)
...
![création de la base de données matomo](/src/assets/articles/serveur-matomo/bdd-5.png)
...
![début de l'installation de matomo](/src/assets/articles/serveur-matomo/matomo-6.png)
...
![ajouter la base de données matomo](/src/assets/articles/serveur-matomo/database-setup-7.png)
...
![super utilisateur matomo](/src/assets/articles/serveur-matomo/super-user-9.png)
