...
date: "2023-04-21"
image: "/image/articles/serveur-matomo/matomo-serveur-installation.jpg"
categories: ["Matomo"]
---
...
![téléchargement de la dernière version de matomo](/image/articles/serveur-matomo/matomo-latest-1.png)
...
![informations sur ovh](/image/articles/serveur-matomo/ovh-2.png)
...
![ports mamp](/image/articles/serveur-matomo/ports-3.png)
...
![configuration mamp](/image/articles/serveur-matomo/mamp-4.png)
...
![création de la base de données matomo](/image/articles/serveur-matomo/bdd-5.png)
...
![début de l'installation de matomo](/image/articles/serveur-matomo/matomo-6.png)
...
![ajouter la base de données matomo](/image/articles/serveur-matomo/database-setup-7.png)
...
![super utilisateur matomo](/image/articles/serveur-matomo/super-user-9.png)
