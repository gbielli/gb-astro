...
Prenez un petit café, posez-vous confortablement et laissez moi vous expliquer **comment configurer Piwik Pro avec Google Tag Manager**. On va aborder le script de suivi Piwik Pro, les dimensions et les évènements personnalisés, lesobjectifs et la mise en place d'un user_id.
...
Voici un exemple de code pour poussez ces informations dans le dataLayer, **l'évènement doit être envoyé très tôt et avant la page vue sur Google Tag Manager** :
